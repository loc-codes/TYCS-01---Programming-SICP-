...
;(inc 8)
;9
;This is a recursive process as it builds a chain of deferred operations
...
;(+ 0 9)
;9
;This is a iterative process as it "does not grow". It has a fixed number of
;variables, which only ever reaches 3
